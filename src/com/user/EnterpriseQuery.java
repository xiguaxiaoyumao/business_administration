...
public class EnterpriseQuery extends JPanel {
    ...
    public EnterpriseQuery() {
        ...
        //defaultTableCellRenderer.setBackground(MyColor.BACK);
        //defaultTableCellRenderer.setForeground(MyColor.FORE);
    ...
    private void setForeColor(Color color)
    {
        ...
        this.remindLabel.setForeground(color);
    }
}
