...
public class CancelRegisterChartSeries extends JPanel {
    ...
    public CancelRegisterChartSeries() {
        this.setLayout(null);
    ...
    private XYDataset createDataset() {
        try {
            ...
            for (int i = 0; i < 12; i++) {
                String SQL = "select count(*) from cancel_the_condition WHERE ZXRQ BETWEEN ? AND ?";
        ...
        //添加数据
        TimeSeries timeseries = new TimeSeries("企业数量", Month.class);
